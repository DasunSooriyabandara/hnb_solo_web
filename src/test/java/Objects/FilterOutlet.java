...
public class FilterOutlet {
    ...
    private By merchantNameSelect = By.id("react-select-2-option-10");
    ...
    private By name = By.xpath("//div[@class='PrivateSwipeArea-root-227 PrivateSwipeArea-anchorTop-230']");
    private By merchant = By.xpath("//div[@class='PrivateSwipeArea-root-227 PrivateSwipeArea-anchorTop-230']");
